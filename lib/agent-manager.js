...
class AgentManager {
  ...
  // while the git probe is in flight supersedes the result via suggestToken.
  // Note the result event lands while the CLI process is still closing —
  // adapter busy-ness here means "run finished", not "stale".
